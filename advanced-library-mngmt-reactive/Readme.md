...
-   http://localhost:8081/api/alm/reactive/books/1

## References

-   [Debugger doesn't work at all in Java projects with enabled Kotlin plugin and coroutine debugger](https://youtrack.jetbrains.com/issue/KTIJ-15750)
