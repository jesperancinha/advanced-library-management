...
import org.jesperancinha.management.gate.services.AlmG2BookService.Companion.ALMR_TC_2
...
class AlmG2BookStartupServiceTest @Autowired constructor(
    ...
    private fun getCBStatus(): String {
        ...
        return forEntity.body?.components?.circuitBreakers?.details?.get(ALMR_TC_2)?.get("status") as String
    }
}
